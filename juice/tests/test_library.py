...
class TestGetArtists(TestWithCLI):
  def test_all_artists(self):
    ...
    self.assertEqual([{'id': 1024, 'name': "5 Seconds of Summer"},
                      {'id': 92, 'name': "6 Notes"},
                      {'id': 725, 'name': "702"},
                      {'id': 954, 'name': "98 Degrees"},
                      {'id': 732, 'name': "Aaliyah"},
                      {'id': 660, 'name': "ABBA"},
                      {'id': 89, 'name': "Abigail Washburn"},
                      {'id': 1283, 'name': "Colonel Abrams"},
                      {'id': 189, 'name': "Aceface"},
                      {'id': 1326, 'name': "Oleta Adams"}],
                     get_artists(self.tn))
    self.tn.read_until.assert_called_once_with(b'\n')
    self.tn.write.assert_called_once_with(b'artists 0 9999 tags:lytiqwaSesucj\n')
